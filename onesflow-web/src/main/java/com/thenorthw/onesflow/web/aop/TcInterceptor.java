package com.thenorthw.onesflow.web.aop;
...
public class TcInterceptor {
    ...
    @Around("execution(* com.thenorthw.onesflow.web.controller..*(..)) && args(..,bindingResult))")
    ...
    @Around("execution(* com.thenorthw.onesflow.web.controller..*(..)) && args()")
